...
public class DialogDept extends JDialog implements ActionListener{
    ...
    public void designaDepartamentoAFrame(Dept umDept)
	{
		...
		numeroTextField.setText(Double.toString(umDept.getDeptno()));  
    ...
    public DialogDept(JFrame frame){
		...
		localizacaoComboBox.setModel(new DefaultComboBoxModel <String>(new String[] {"", "Praia vermelha", "Valonguinho", "Gragoata", "Rio das Ostras"}));
		...
		cadastrarFuncButton = new JButton("Cad Func");
		cadastrarFuncButton.setBounds(452, 239, 96, 23);
		panel.add(cadastrarFuncButton);
		cadastrarFuncButton.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == novoButton){	
			...
			if(!deuErro){
				...
				umDept.setDeptno(Double.parseDouble(numeroTextField.getText()));
